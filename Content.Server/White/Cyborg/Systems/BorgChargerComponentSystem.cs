...
public sealed class BorgChargerComponentSystem : EntitySystem
{
    ...
    private void OnRelayMovement(EntityUid uid, BorgChargerComponent scannerComponent,
    ...
    private BorgChargerVisualInfo GetStatus(EntityUid uid, BorgChargerComponent chargerComponent)
    {
        ...
        info.MachineLayer = IsOccupied(chargerComponent)
            ? BorgChargerComponent.BorgChargerVisuals.Closed
            : BorgChargerComponent.BorgChargerVisuals.Opened;

        if (this.IsPowered(uid, EntityManager))
        {
            if (IsOccupied(chargerComponent))
            {
                void LocalCharged()
                {
