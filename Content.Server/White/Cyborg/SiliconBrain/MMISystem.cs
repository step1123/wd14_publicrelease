...
public sealed class MMISystem : SharedMMISystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SiliconBrainComponent, BrainInsertedToMMIEvent>(OnInserted);
    ...
    private void OnInserted(EntityUid uid, SiliconBrainComponent component, BrainInsertedToMMIEvent args)
    {
    ...
    public void UpdateAppearance(EntityUid uid, MMIComponent? component = null,
