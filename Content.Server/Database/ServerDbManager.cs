...
namespace Content.Server.Database
{
    ...
    public sealed class ServerDbManager : IServerDbManager
    {
        ...
        {
            DbReadOpsMetric.Inc();
            return RunDbCommand(() => _db.GetServerBanAsync(address, userId, hwId, ignoreServerName));
        }
        ...
        {
            DbReadOpsMetric.Inc();
            return RunDbCommand(() => _db.GetServerBansAsync(address, userId, hwId, includeUnbanned, ignoreServerName));
        }
        ...
        {
            DbReadOpsMetric.Inc();
            return RunDbCommand(() => _db.GetServerRoleBansAsync(address, userId, hwId, includeUnbanned, ignoreServerName));
        }
