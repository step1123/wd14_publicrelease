...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        IConsoleShell? shell = null, IPlayerSession? player = null, string? nameOverride = null, bool checkRadioPrefix = true, bool force = false)
    {
        ...
        bool sanitizeSlang = _configurationManager.GetCVar(WhiteCVars.ChatSlangFilter);
        ...
        {
            SendEntityEmote(source, emoteStr, range, nameOverride, force: force);
        }
        ...
        switch (desiredType)
        {
            ...
            case InGameICChatType.Emote:
                SendEntityEmote(source, message, range, nameOverride, force: force);
                break;
        }
    }
    ...
    private void SendEntityEmote(EntityUid source, string action, ChatTransmitRange range, string? nameOverride, bool checkEmote = true, bool force = false)
    {
