...
namespace Content.Shared.White.Cyborg.Charge;

public abstract class SharedSiliconChargerSystem : EntitySystem
{
    ...
    public void UpdateState(EntityUid uid, SiliconChargerComponent? component = null)
    {
        ...
        else
        {
            ...
            if (EntityManager.TryGetComponent<SharedEntityStorageComponent>(uid, out var storageComp) && storageComp.Open)
