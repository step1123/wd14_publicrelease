book-text-plasma-trap = Хехехехех, ни за что на свете они теперь не доберутся до нашей заначки, не так ли?
...
book-text-holoparasite-info = Спасибо, что выбрали нашу упаковку от голопаразитов!
...
book-text-ame-scribbles = Я не знаю, прошли ли вы уже обучение, поэтому я надеюсь, что это поможет.
