book-text-spacelaw =
    ...
    Смотритель или Глава службы безопасности несут ответственность за заключенных.
        ...
        Заключенным осужденным на пожизненное не разрешается иметь какие-либо личные вещи.
            ...
            Применение силы
    Сотрудник службы безопасности станции - один из самых вооруженных и защищенных людей на станции, оснащенный почти новейшими технологиями не летального усмирения нарушителей. В подавляющем случае нужно использовать оглушающие нарушителя средства, но в некоторых обстоятельствах летальное оружие допустимо:
        ...
        Высокие риски во время задержания - попытка арестовать неизвестного проникающего на станцию скорее всего закончится смертью офицера СБ поэтому устранение летальным оружием будет оправдана.
