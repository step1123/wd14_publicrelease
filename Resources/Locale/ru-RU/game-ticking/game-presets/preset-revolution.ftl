...
rev-welcome-headrev =
    ...
    В вашем рюкзаке находится вспышка. Используйте её в режиме боя на другом члене экипажа для того чтобы путем гипноза передать ему свои революционные идеалы.
...
rev-cond-allcrewheadsdead = Все главы станции погибли или покинули станцию.
