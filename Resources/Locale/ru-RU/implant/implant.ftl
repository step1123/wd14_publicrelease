...
action-desc-honk = Активирует гудящий имплант, который будет издавать характерный звук клоуна.
use-emp-implant-action-name = Активировать ЭМИ
use-emp-implant-action-description = Запускает небольшой импульс ЭМИ вокруг вас.
use-dna-scrambler-implant-action-name = Скремблировать ДНК
use-dna-scrambler-implant-action-description = ЛИНГ В ТЕХАХ!
open-uplink-implant-action-description = Открывает восходящий канал синдиката, встроенный в вашу кожу
scramble-attempt-while-scrambled-popup = Обнаружена зашифрованная ДНК, пожалуйста, извлеките имплантат перед отменой текущей зашифрованной информации.
scramble-implant-activated-popup = Вы превратились в { $identity }
deathrattle-implant-dead-message = { $user } умер в { $position }.
deathrattle-implant-critical-message = { $user } признаки жизни критические, требуется немедленная помощь в { $position }.
