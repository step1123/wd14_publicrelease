...
ent-VendingMachineRestockVendomat = набор пополнения ВендоМат
    .desc = Коробка, полная деталей для различных машин. Для начала загрузите его в ВендоМат.
    .suffix = { "" }
ent-VendingMachineRestockRobotics = набор пополнения Роботех Делюкса
    .desc = Коробка, полная инструментов для создания боргов. Загрузите его в Роботех Делюкс, чтобы начать.
    .suffix = { "" }
