...
ui-options-hud-theme-modernized = Устаревший
ui-options-hud-theme-classic = Стандартный
...
cmd-options-desc = Открывает меню настроек, опиционально с нужной вкладкой.
cmd-options-help = Использование: настройки [tab]
