...
reagent-desc-spider-blood = На вкус не похоже на черничный сок.
reagent-name-zombie-blood = кровь зомби
reagent-desc-zombie-blood = Не советовал бы есть. Может использоваться для создания прививки против инфекции.
...
reagent-desc-fat = Каким бы способом оно ни было получено, важно его применение.
reagent-name-vomit = рвота
reagent-desc-vomit = Вы можете увидеть несколько кусков чьей-то последней еды в нем.
