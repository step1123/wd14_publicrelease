...
reagent-desc-romerol = Потусторонняя смесь, способная оживить нежить. Если не лечить, последствия необратимы и обречены на станцию. Обращаться осторожно.
...
reagent-desc-lead = Медленно действующий, но невероятно смертельный токсин, содержащийся в стали, хотя и в следовых количествах. Безвкусный.
reagent-name-honk = хонк
reagent-desc-honk = Токсин, обнаруженный в бананиуме. Вызывает сильное гудение и внутреннее кровотечение, а также может привести к мутации пациента.
