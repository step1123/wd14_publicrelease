...
charge-artifact-popup = Вы чувствуете, как воздух гудит от электричества.

activate-artifact-action-name = Активировать артефакт
activate-artifact-action-desc = Немедленно активирует ваш текущий узел артефакта.
